...
resource "openstack_compute_instance_v2" "ubuntu24" {
  ...
  security_groups = ["4ddb369d-f34a-4ba5-a4b6-31c840199736","${openstack_networking_secgroup_v2.ssh_ping_security_group.id}", "default", "${openstack_networking_secgroup_v2.http_https_security_group.id}"]
  metadata = {
